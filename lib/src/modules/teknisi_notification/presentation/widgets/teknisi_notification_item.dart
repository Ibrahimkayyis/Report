...
class TeknisiNotificationItem extends StatelessWidget {
  // ... (Constructor dan Properties SAMA, tidak berubah) ...
  final String title;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  // 🔴 PERBAIKAN: Gunakan Flex/Expanded agar Judul tidak terpotong sembarangan
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Judul (Ambil sisa space)
                      Expanded(
                        child: Text(
                          title,
                          style: TextStyle(
                          ...
                          maxLines: 1, // Batasi 1 baris untuk judul agar rapi
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            time,
                            style: TextStyle(
                              fontSize: 10.sp, // Sedikit diperkecil agar muat
                              color: isRead 
